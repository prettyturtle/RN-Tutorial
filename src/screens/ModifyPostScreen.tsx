...
import { getPost, updatePost } from "../data/postData";
...
type Props = RouteProp<RootStackParamList, "ModifyPostModal">;
			...
			<View style={styles.buttonContainer}>
				...
				>
					<Text
						style={[
							styles.submitButtonText,
							styles.submitButtonTextPrimary,
						]}
					>
						수정
					</Text>
